...
{ 
    ...
    public class BuildHooks {
        ...
        {
            var obsoleteFile = Path.Combine(pluginDirectory, "x86_64", nameOfObsoleteFile + fileEnding);
            ...
            var targetFile = Path.Combine(pluginDirectory, "x86_64", LIB_LSL_NAME + fileEnding);
